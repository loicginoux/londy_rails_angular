...
Set values for @ADMIN_NAME@, @ADMIN_EMAIL@, and @ADMIN_PASSWORD@ for a user that is created when the database is seeded. You will be able to log in to the application with these credentials.
